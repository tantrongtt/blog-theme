...
<div class="Image__Large">
  <img src="./images/portfolio-carousell-hero.jpg" />
</div>
...
<div class="Grid Col2 Small Space-Small">
  ...
  <div>
    ...
    <p>I designed for iOS, Android, mobile Web, and desktop Web. I executed journeys, wireframes, prototypes, design specs, and collaborate with Engineers.</p>
  </div>
  <div>
    <h4>Leadership</h4>
...
<div class="Grid Col2-ShortLeft Medium">
  <div>
    <h3>The current location approach</h3>
    <p>
  ...
  <div>
    <video autoplay loop muted playsinline src="./images/video-radius.mp4"></video>
  </div>
</div>
...
Some people don’t they can filter by locations
<div class="Image__Small">
...
[image with all platform: iOS, Android, Web] or [video with the real product on hand]

<div class="Image__Large">
  <video autoplay loop muted playsinline src="http://michaelevensen.com/media/videos/player.mp4"></video>
</div>
...
<div class="Grid Col2-ShortLeft Medium">
  ...
  <div>
    <video autoplay loop muted playsinline src="./images/video-new-1.mp4"></video>
  </div>
</div>
...
<div class="Grid Col2-ShortLeft Medium">
  ...
  <div>
    <video autoplay loop muted playsinline src="./images/video-new-2.mp4"></video>
  </div>
</div>
...
<div class="Grid Col2-ShortLeft Medium">
  <div>
    <p>
      Useful shortcuts to select location faster
    </p>
  </div>
  <div>
    <video autoplay loop muted playsinline src="./images/video-new-3.mp4"></video>
  </div>
</div>

3. Useful shortcuts to select location faster
	[image with handwriting note]

	* Select current location based on people’s GPS
	* Location from there profile or browse the whole countries
	- Recent locations that they have selected. People usually browse in some specific areas where they live or work.
	* Recommended areas

4. For Property in Singapore, people can browse by District, MRT, or Estate.

5. Number of item indicators to show the system state as a guide for people to decide if they should use filter to narrow down or change to a bigger area to see more available items. We didn't have it before because we didn't want our competitors to know where we are in the market. But it’s useful info for buyers while search. So we have to find a way to balance it.

6. Don't’ forget about the empty state. It’s where we can suggest them to do something. Those small details contribute to a great product

7. For Property, adding location info to the listing card to help people find suitable houses easier.

8. And it works across all platforms
[Android, mobile web, desktop web]

## Outcome?
Not yet. But can add impression from other people.
...
Thanks to all engineers who worked hard on this project: Beemo &… (iOS); Tim & Lance Wang (Android); Jenny, Chenghau & Andrew (Web); and genius back-end guys Steven, Tuan.
