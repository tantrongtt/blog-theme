...
- A solution that works for different categories: General goods vs Property
...
<div class="Image__Small">
  <img src="./images/image-location-14_2.png" />
  <figcaption>Location picker entry ideas</figcaption>
</div>
...
<div class="Grid Col2-ShortLeft Small">
  <div>
    <h4>New location selection in the item creation form</h4>
    <p>
      Besides the browsing flow, we also changed the location selection in the item creation form to improve user experience and make it work with the brand new data structure.  
    </p>
    </div>
  <div class="PaddingMobile">
    <video class="Round" autoplay loop muted playsinline src="./images/video-new-8.mp4"></video>
  </div>
