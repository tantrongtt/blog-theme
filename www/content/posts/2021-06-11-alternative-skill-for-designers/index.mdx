---
title: Essensial skills for product designers
author: Trong Nguyen
date: 2021-06-11
hero: ./images/trongnguyen-alternative-skills-for-designers-2.png
excerpt: For designers, only good design skill doesn’t guarantee success. We need more skills to be better and succeed in your career. But not only for the design career, but it’s also for any other career you are considering. This lesson is valuable and I want young designers to know to succeed.
categories: ['Design', 'Lavida']
---

In the previous post, I shared about [why every new skill you acquire will double your odds of success](https://trongnguyen.co/systems-vs-goals) and listed down a list of essential skills that Scott recommended. In this post, I want to elaborate on each skill on why they are important, and how you can learn it.
